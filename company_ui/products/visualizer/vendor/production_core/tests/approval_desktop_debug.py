...
with sync_playwright() as p:
    ...
    for label,viewport in [('desktop',{'width':1440,'height':1000})]:
        ...
        print('SET',label,flush=True);page.set_content(bundle_html(),wait_until='load');page.wait_for_timeout(350);print('GALLERY',flush=True)
        ...
        print('LAYOUT',flush=True);page.get_by_role('button',name='Dynamic Grid').click();page.wait_for_timeout(80);report['checks'][f'{label}_dynamic_grid']=page.locator('#slideStage .sim-item').count()==5
        ...
        print('GRID',flush=True);page.get_by_role('button',name='100k Grid').click();page.wait_for_timeout(950)
        ...
        print('PPT',flush=True);page.get_by_role('button',name='PPT Region').click();page.wait_for_timeout(70);report['checks'][f'{label}_ppt_middle_region']=page.locator('#exportStage .sim-item').count()==5
