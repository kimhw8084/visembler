...
export const PRODUCTION_LIBRARY = Object.freeze({
  ...
  CoreChartEngine: freezeItems([
    ...
    {element:'Multi-Line', description:'Compare multiple measured series across a shared ordered axis.'},
    {element:'Scatter Plot', description:'Investigate the relationship between two numeric measures.'},
    {element:'Regression Scatter', description:'Assess a numeric relationship with a transparent fitted trend.'},
    {element:'Histogram', description:'Inspect the distribution of one numeric measurement.'},
    {element:'Box Plot', description:'Compare numeric spread, median, and outliers.'},
    {element:'Pareto', description:'Prioritize categorical contributors by descending impact and cumulative share.'},
  ]),
  ...
  EngineeringChartEngine: freezeItems([
    ...
    {element:'Xbar-R Chart', description:'Validated constant-size subgroup means and ranges with explicit control limits.'},
    {element:'DOE Main Effects', description:'Observed response means by experimental factor level; descriptive, not significance testing.'},
    {element:'DOE Interaction Plot', description:'Observed response means across two factor dimensions; descriptive interaction evidence.'},
  ]),
...
export const PRODUCTION_RECOMMENDED = Object.freeze([
  ...
  'CoreChartEngine::Pareto',
  'CoreChartEngine::Scatter Plot',
  'CoreChartEngine::Histogram',
  ...
  'EngineeringChartEngine::Xbar-R Chart',
  'EngineeringChartEngine::DOE Main Effects',
  'EngineeringChartEngine::DOE Interaction Plot',
