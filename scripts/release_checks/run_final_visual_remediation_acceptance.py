...
NAMES={
 ...
 'VR048':'Stage A regression','VR049':'Stage B regression','VR050':'Stage C regression','VR051':'Stage D regression','VR052':'49 production elements','VR053':'data workflows','VR054':'product contract','VR055':'no unexpected browser errors','VR056':'frozen connector unchanged',
}
...
""")
        attempt('VR001',lambda: (_ for _ in ()).throw(AssertionError('production registry is not 49')) if pure['count']!=49 or len(pure['entries'])!=49 else None)
