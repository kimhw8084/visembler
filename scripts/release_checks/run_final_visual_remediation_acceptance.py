...
NAMES={
 ...
 'VR048':'Stage A regression','VR049':'Stage B regression','VR050':'Stage C regression','VR051':'Stage D regression','VR052':'45 production elements','VR053':'data workflows','VR054':'product contract','VR055':'no unexpected browser errors','VR056':'frozen connector unchanged',
}
...
""")
        attempt('VR001',lambda: (_ for _ in ()).throw(AssertionError('production registry is not 45')) if pure['count']!=45 or len(pure['entries'])!=45 else None)
