...
| `DataResult` | class | `company_ui.data_engine.models` | `(rows: "'tuple[dict[str, Any], ...]'", total: "'int'", revision: "'int'" = 0, filtered_total: "'int \| None'" = None, source_revision: "'int'" = 0) -> 'None'` |
...
| `Dataset` | class | `company_ui.data_engine.engine` | `(key: "'str'", rows: "'Sequence[Mapping[str, Any]]'", dimensions: "'Sequence[Dimension]'" = (), metrics: "'Sequence[Metric]'" = (), row_key: "'str \| None'" = None, revision: "'int'" = 0)` |
