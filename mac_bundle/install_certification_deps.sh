...
if [[ ! -x "$VENV/bin/python" ]]; then echo "Run ./setup_mac.sh first."; exit 1; fi
...
echo "Running browser-certification preflight..."
"$VENV/bin/company-ui-mac-preflight" --port 8080
